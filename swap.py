...
class BarterContract(sp.Contract):
    ...
    def accept_trade(self, trade_id):
        ...
        sp.if (trade.user2_accepted == True) & (trade.user2_accepted == True):
    ...
    def fa2_update_operators(self, fa2, from_, operator, token_id):
        """Gives operator rights to this contract for the given fa2 and token_id
        """
        # Get a handle to the FA2 token transfer entry point
        c = sp.contract(
            t=sp.TList(
...
sp.add_compilation_target("barter", BarterContract(
    manager=sp.address("tz1aprGCTs1uU9BQfvBbq3pmiwHnX54JD5Es"),
